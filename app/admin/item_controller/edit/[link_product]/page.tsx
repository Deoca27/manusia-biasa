        ...
        <>
            <div className="text-center font-extrabold text-2xl">EDIT DATA BARANG</div>
                ...
                <div className="grid grid-cols-10 gap-4 mt-16">
                    <input type="text" placeholder="Type here" className="input input-bordered col-start-4 col-span-4" />
                    <input type="text" placeholder="Type here" className="input input-bordered col-start-4 col-span-4" />
                    <input type="text" placeholder="Type here" className="input input-bordered col-start-4 col-span-4" />
                    <select className="select select-bordered col-start-4 col-span-4">
